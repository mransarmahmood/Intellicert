# M9.63 — Management of Change (MOC)

**Status:** `draft_for_sme` · **Blueprint:** D2.T5 / D1.T2 · **Calculation topic:** No

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M9.63` after edits._
