# M1.02 — Event Tree Analysis (ETA)

**Status:** `draft_for_sme` · **Blueprint:** D2.T6 · **Calculation topic:** No

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M1.02` after edits._
