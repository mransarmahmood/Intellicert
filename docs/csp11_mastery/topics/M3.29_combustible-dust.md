# M3.29 — Combustible Dust

**Status:** `draft_for_sme` · **Blueprint:** D6.T1 / D1.T2 · **Calculation topic:** No

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M3.29` after edits._
