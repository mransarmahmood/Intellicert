# M9.65 — SIL & Safety Instrumented Systems

**Status:** `draft_for_sme` · **Blueprint:** D1.T2 · **Calculation topic:** Yes

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M9.65` after edits._
