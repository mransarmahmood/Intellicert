# M4.31 — Confidence Intervals

**Status:** `draft_for_sme` · **Blueprint:** D2.T14 · **Calculation topic:** Yes

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M4.31` after edits._
