# M5.39 — LTIFR (International)

**Status:** `draft_for_sme` · **Blueprint:** D2.T7 · **Calculation topic:** Yes

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M5.39` after edits._
