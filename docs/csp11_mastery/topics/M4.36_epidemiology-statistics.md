# M4.36 — Epidemiology Statistics

**Status:** `draft_for_sme` · **Blueprint:** D6.T2 · **Calculation topic:** Yes

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M4.36` after edits._
