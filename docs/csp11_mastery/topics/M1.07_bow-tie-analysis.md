# M1.07 — Bow-Tie Analysis

**Status:** `draft_for_sme` · **Blueprint:** D2.T6 / D3.T2 · **Calculation topic:** No

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M1.07` after edits._
