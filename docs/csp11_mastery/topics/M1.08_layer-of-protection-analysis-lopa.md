# M1.08 — Layer of Protection Analysis (LOPA)

**Status:** `draft_for_sme` · **Blueprint:** D2.T6 / D1.T2 · **Calculation topic:** Yes

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M1.08` after edits._
...
_Inputs (units, ranges) → step-by-step reveal → worked GCC example → variant challenge → auto-graded answer._
