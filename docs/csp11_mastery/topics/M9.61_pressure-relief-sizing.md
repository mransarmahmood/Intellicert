# M9.61 — Pressure Relief Sizing

**Status:** `draft_for_sme` · **Blueprint:** D1.T2 · **Calculation topic:** Yes

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M9.61` after edits._
