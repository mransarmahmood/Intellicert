# M9.64 — PHA Method Selection

**Status:** `draft_for_sme` · **Blueprint:** D1.T2 · **Calculation topic:** No

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M9.64` after edits._
