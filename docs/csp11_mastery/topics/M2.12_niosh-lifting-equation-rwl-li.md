# M2.12 — NIOSH Lifting Equation (RWL & LI)

**Status:** `draft_for_sme` · **Blueprint:** D6.T4 · **Calculation topic:** Yes

_This file is the SME defensibility evidence for this Mastery topic. Authoring follows the 18-element Gold Standard. Run `php artisan mastery:check-defensibility --id=M2.12` after edits._
